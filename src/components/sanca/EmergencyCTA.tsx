...
export default function EmergencyCTA() {
  return (
    <section id="emergency" className="py-20 sm:py-28 relative overflow-hidden section-wave-gold-bottom">
      {/* Background — base gradient fallback */}
      ...
      <img
        src="/images/sanca/sunrise-hope-path.png"
        alt=""
        aria-hidden="true"
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-sanca-green-dark/90 via-sanca-green-dark/75 to-sanca-emerald/70" />
